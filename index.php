        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="form-toggle"><a href="#">Кабінет</a>

                        <div class="form-wrapper">
                            <div class="form-title">
                                <input type="radio" name="form-title" id="form-title_first-name" checked>
                                <label for="form-title_first-name">First name</label>

                                <input type="radio" name="form-title" id="form-title_settings">
                                <label for="form-title_settings">Settings</label>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <?php foreach ($categories as $category) : ?>
                                ...
                                <?php if ($category == 'Комп`ютери') : ?>
                                    <li class="dropdown subcategories"><a href="#"><?= $category; ?><span
                                                    class="caret"></span></a>
                                        <ul class="dropdown-menu">
                    ...
                    <li><a href="index.php?download=true"><u>Завантажити <b>test20html.php</b></u></a></li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
    </nav>
            ...
            <div class="col-sm-4">
                ...
                <ul>
                    <li>Максимально точно зверстати форму по макету вказаному нижче (звернути увагу, що input та
                        checkbox мають не стандартний вид!)
                    </li>
